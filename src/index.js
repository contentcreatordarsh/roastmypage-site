...
import { handleRouteModules } from './routes/router.js';
import { handleAdminRoutes } from './routes/admin.js';
import { handleApiV1Routes } from './routes/apiV1.js';
import { handleExtrasRoutes } from './routes/extras.js';
import { handlePublicDataRoutes } from './routes/publicData.js';
...
export default {
    ...
    const routeResponse = await handleRouteModules([
      handlePublicDataRoutes,
      handleAdminRoutes,
      handleApiV1Routes,
      handleExtrasRoutes
    ], request, env22, ctx, { url, origin, corsHeaders });
    if (routeResponse) {
